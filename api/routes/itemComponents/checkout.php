...
// Ensure socket event helpers are available and non-blocking
...
function handleCheckout() {
    ...
    try {
        ...
        // ✅ Emit real-time event for checkout completion (non-blocking)
        try {
            $socketEvents = getSocketEvents();
            $socketEvents->checkoutCompleted([
            ...
            error_log('Socket event emission failed (checkoutCompleted): ' . $e->getMessage());
